        ...
        <div className="conversation-thread">
          <div className="thread-header">
            ...
            <div className="thread-meta">
              <span className="thread-time">5 min ago</span>
          ...
          <div className="message message-received">
            ...
            <div className="message-time">11:44 AM</div>
          </div>
        </div>
        ...
        <div className="typing-indicator">
          <div className="typing-icon">
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12.04 2c-5.46 0-9.91 4.45-9.91 9.91 0 1.75.46 3.39 1.32 4.82L2.05 22l5.25-1.38c1.45.79 3.08 1.21 4.74 1.21 5.46 0 9.91-4.45 9.91-9.91S17.5 2 12.04 2zm4.64 13.34c-.15.42-.83.77-1.14.82-.3.05-.68.07-1.06-.08-.24-.09-.55-.21-.95-.41-1.66-.8-2.74-2.33-2.82-2.44-.08-.1-.66-.88-.66-1.68s.43-1.19.58-1.36c.15-.17.33-.21.44-.21.11 0 .22-.01.32-.01.11 0 .27-.04.42.2.15.25.51.98.55 1.05.04.07.07.16.02.26-.05.11-.08.19-.16.26-.08.07-.16.15-.23.2-.07.05-.15.1-.07.2.08.1.35.47.75.76 1.06.75 1.95.98 2.19 1.09.24.11.39.09.53-.07.15-.15.33-.43.45-.58.12-.15.24-.13.4-.08.16.05 1.02.48 1.2.57.18.09.3.14.34.22.04.08.04.48-.11.9z"/>
            </svg>
          </div>
