...
export default function SidebarIcons({ className = '' }: SidebarIconsProps) {
  return (
    <div className={`sidebar-icons-container ${className}`}>
      <div className="sidebar-icons">
        ...
        <button className="sidebar-icon" title="Share">
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <button className="sidebar-icon" title="Checklist">
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <button className="sidebar-icon" title="Calendar">
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
